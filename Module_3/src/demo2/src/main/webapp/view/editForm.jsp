...
<div align="center">
    <form action="/room?action=update" method="post">
        ...
        <table border="1" cellpadding="5">
            <tr>
                <td>
                    <input type="hidden" name="id" value="${room.getId()}" size="45"/>
                </td>
            </tr>
            <tr>
                <th>Tên khách hàng:</th>
                <td>
                    <input type="text" name="name" value="${room.getName()}" size="45"/>
                </td>
            </tr>
            <tr>
                <th>Số điện thoại:</th>
                <td>
                    <input type="text" name="phoneNumber" value="${room.getPhoneNumber()}" size="45"/>
                </td>
            </tr>
            <tr>
                <th>Ngày bắt đầu:</th>
                <td>
                    <input type="text" name="ngayBatDau" value="${room.getStartDay()}" size="45"/>
                </td>
            </tr>
            <tr>
